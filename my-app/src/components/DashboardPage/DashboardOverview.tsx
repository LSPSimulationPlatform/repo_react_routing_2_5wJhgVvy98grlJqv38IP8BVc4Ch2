...
// Props tipini müəyyən edirik
type DashboardOverviewProps = {
  location: any;
  loginState?: any;
  menuItems?: { key: string; icon: JSX.Element; label: JSX.Element }[];
};

// DashboardOverview komponenti
const DashboardOverview = ({ location, loginState, menuItems }: DashboardOverviewProps) => {
  return (
    <div>
      {/* Page header */}
